...
# 1000 credits at the ~5 a tool turn measured on run 32792379720 is 200 turns.
max_tool_turns: 200
guardrails: [implementing]
skills: [change-format]
github:
  max-ai-credits: { default: 500, min: 100, max: 1000 }
  timeout-minutes: { default: 75, max: 180 }
---
